...
function i18n(){
  ...
  if(isEn){
    return {
      ...
      downloaded: "CV PDF downloaded",
      failed: "Could not generate PDF. Using Print...",
      locale: "en-US",
      fileName: "Marian-Dumitru-CV-EN.pdf"
    };
  }

  return {
    generating: "Generez PDF...",
    downloaded: "CV PDF descarcat",
    failed: "Nu am putut genera PDF. Folosesc Print...",
    locale: "ro-RO",
    fileName: "Marian-Dumitru-CV-IT-Project-Digital-Ops.pdf"
  };
}
...
async function exportPdf(){
  ...
  try{
    ...
    if(generatedAtEl){
      ...
      const time = now.toLocaleTimeString(t.locale, { hour: "2-digit", minute: "2-digit", second: "2-digit" });
